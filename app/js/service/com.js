define(function(){
    ...
    var app = angular.module('canvasCom', []);
...
//                this.lastChild = com;
            ...
            render : function(dt, context){
                ...
                this.beforeRender && this.beforeRender.call(this, dt);
                ...
                this.afterRender && this.afterRender.call(this, dt);
            },
            ...
            _createPath : function(context){
                if(this.shape) {
                    ...
                    COM.Shape.Rect.draw(this, context);
                }
            },
